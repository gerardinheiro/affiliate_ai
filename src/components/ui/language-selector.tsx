        ...
        <div className="relative">
            ...
            {isOpen && (
                <>
                    ...
                    />
                    <div className="absolute right-0 top-12 z-50 min-w-[150px] max-h-[300px] overflow-y-auto glass border border-white/10 bg-black/90 backdrop-blur-xl rounded-md shadow-lg p-1">
                        <button
                            onClick={() => { setLocale('pt-BR'); setIsOpen(false) }}
                        ...
                        <button
                            onClick={() => { setLocale('fil'); setIsOpen(false) }}
