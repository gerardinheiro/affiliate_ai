        ...
        <DashboardLayout>
            <div className="flex flex-col gap-8">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    {statsCards.map((stat) => (
                        <Card key={stat.title} className="hover:shadow-lg transition-shadow duration-200 glass border-white/10">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                    <Card className="col-span-4 glass border-white/10">
                        <CardHeader>
                            <CardTitle className="text-white">Visão Geral de Vendas</CardTitle>
                        </CardHeader>
                                ...
                                {stats.products === 0 && stats.clicks === 0 ? (
                                    ...
                                    <>
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-auto font-medium text-blue-400">{stats.products}</div>
                                        </div>
                                        <div className="flex items-center">
                                            <div className="ml-4 space-y-1">
                                                <p className="text-sm font-medium leading-none text-white">
                                            ...
                                            <div className="ml-auto font-medium text-emerald-400">{stats.clicks}</div>
                                        </div>
                                    </>
                                )}
                            </div>
